...
uint32_t Context::makeMountPortMapperRequest(int32_t rcvTimeo) {
	...
	getPortMapperContext().setMountPort(mountPort);
	return mountPort;
}

#define MOUNT_REQUEST_SIZE		1024

const std::vector<uchar_t>& Context::makeMountCall(uint32_t timeout, const std::string& remote, uint32_t mountVersion) {
